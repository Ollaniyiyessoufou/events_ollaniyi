<template>
   ...
   <div class="flex flex-col  min-h-screen bg-gray-100">
      <NavComponent />
      <div class="mx-4">
         <h1 class="text-4xl text-center font-extrabold text-teal-600 mb-4 mt-8">
       EVENTS MANAGEMENT
     </h1>

     <div  class="flex" >
         <v-calendar style="width: 30%; height: 50%;" :attributes="attributes" />

         <div class="w-[100%] mx-2">

            <div class="w-[100%] mx-auto bg-white shadow-lg rounded-lg p-6">
         <h2 class="text-2xl  text-center font-bold mb-4"> MY EVENTS</h2>
         <div class="flex mb-4">
 ...
 <script setup>
 import Calendar from '@/components/calendrie.vue'
 import NavComponent from '@/components/NavComponent.vue'
 import { useTaskStore } from '@/stores/todo'
 import { ref, computed } from 'vue'
import Modal from '@/components/Modal.vue'
import TaskForm from '@/components/modalForm.vue'
import TaskDetail from '@/components/detailTodo.vue'
 ...
 const attributes = ref([
   {
     ...
     dot: true,
     bar: true,
     popover: { content: 'Example popover content' },
     customData: { info: 'Example data' },
